...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterUsers(departureId) {
        ...
        const observerUsers = selectedDeparture ? JSON.parse(selectedDeparture.dataset.observers || '[]') : [];
    ...
    filterUsers(departureSelect.value);
    document.querySelectorAll('.edit-image-file, .new-image-input').forEach(input => {
