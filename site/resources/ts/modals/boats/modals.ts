...
const handleEditBoatModal = (modal: HTMLDivElement, boatId: string, boatName: string, registrationNumber: string) => {
    const editForm = modal.querySelector<HTMLFormElement>('form');
    const inputBoatName = modal.querySelector<HTMLInputElement>('#boatName');
    const inputRegistrationNumber = modal.querySelector<HTMLInputElement>('#registrationNumber');
...
const handleDeleteBoatModal = (modal: HTMLDivElement, boatId: string, boatName: string, registrationNumber: string) => {
    ...
    const textRegistrationNumber = modal.querySelector<HTMLElement>('#deleteRegistrationNumber');
