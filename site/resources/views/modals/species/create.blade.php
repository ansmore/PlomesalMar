<section class="modal fade modal-common modal__create" id="createSpecies" tabindex="-1" aria-labelledby="modalLabelNuevo"
    aria-hidden="true">

    <div class="modal-dialog modal-lg modal__create__box">
                ...
                <form method="POST" action="{{ route('species.store', ['language' => app()->getLocale()]) }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form__group">
                            ...
                            <input type="text" class="form__group__input" id="nombreCientifico"
                                name="nombre_cientifico" placeholder="Ejemplo: Chlorostilbon maugaeus">
                        </div>
