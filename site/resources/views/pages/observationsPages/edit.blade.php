                        ...
                        <form class="observation-form" method="post"
                            ...
                            <div class="table__group">
                                ...
                                <input type="number" name="number_of_individuals" id="number_of_individuals"
                                    class="input-form" value="{{ $observation->number_of_individuals }}" required>
                            </div>
                            ...
                            @foreach ($imageUrls as $image)
                                <div class="image-container">
                                    ...
                                    <input type="file" name="image_file[{{ $image['image_id'] }}]" accept="image/*"
                                        class="edit-image-file" data-image-id="{{ $image['image_id'] }}"
                                        style="display: none;">
                            ...
                            <button type="submit" class="btn btn-success form__button__success">Guardar Cambios</button>
                        </form>
